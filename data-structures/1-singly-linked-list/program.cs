...
namespace LinkedLists
{
    public class Program
    {
        ...
        {
            System.Console.WriteLine("Singly Linked List. Begin Tests.");
            ...
            System.Console.WriteLine("Singly Linked List. End Tests.");
        }
    }
    ...
    public class SinglyLinkedList<TValueType>
    {
        ...
        public void RemoveLast()
        {
            ...
            {
                // Find the node before _last
                var lastButOne = _first;
                while (lastButOne.NextNode != _last)
                {
